...
const ResultFilter = (props?: Omit<FilterProps, 'children'>) => (
    <Filter {...props}>
        <TextInput label="Search" source="id" alwaysOn />
        <DateInput source="date_completed.<" label="Older than" alwaysOn />
        <DateInput source="date_completed.>" label="Newer than" alwaysOn />
    </Filter>
);

const WcOrderList = () => {
    return (
        <List filters={<ResultFilter />}>
